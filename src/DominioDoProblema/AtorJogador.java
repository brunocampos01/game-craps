...
public class AtorJogador {
	...
	protected String idUsuario;
        ...
        protected Jogador jogador, advers;
	...
	return resultadoInicio;
        ...
        public void enviarJogada(int dado1, int dado2, int somaDados, int vitoriasJogador1, int vitoriasJogador2,
        ...
        {        
            Lance lance = mesa.informarJogada(dado1, dado2, somaDados, mesa.vitoriasJogador1, mesa.vitoriasJogador2,
                mesa.derrotasJogador1, mesa.derrotasJogador2, totalApostasJogador1, totalApostasJogador2, point, apostasJogador1, 
                apostasJogador2, mesa.contaJogada, mesa.resultadoRodada);
	...
	public void receberJogada(Lance jogada) {      
            mesa.receberJogada(jogada.informarDado1(), jogada.informarDado2(), jogada.informarSomaDados() 
                    ,jogada.informarTotalApostasJogador1(),jogada.informarTotalApostasJogador2()
                    ,jogada.informarPoint() ,jogada.informarApostasJogador1()
                    ,jogada.informarApostasJogador2() ,jogada.contaJogada(),jogada.resultadoRodada());             
            //verifica rodada e verifica jogada - somente executa quando lancouDados == true(o adversario lançou os dados)
            mesa.conferirTodosResultados();
