...
public class Mesa {	
    ...
    public Mesa (DisplayMesa displ){
        ...
        public Lance informarJogada(int dado1, int dado2, int somaDados, int vitoriasJogador1, int vitoriasJogador2,
            ...
            ,List informarApostasJogador1, List informarApostasJogador2, int contaJogada, int resultadoRodada) {
        Lance lance = new Lance();
        lance.assumir(dado1, dado2, somaDados, vitoriasJogador1, vitoriasJogador2,
            derrotasJogador1, derrotasJogador2, totalApostasJogador1, totalApostasJogador2, point
            ,informarApostasJogador1, informarApostasJogador2, contaJogada, resultadoRodada);
        return lance;		
	}
	...
	public void criarJogador(String idJogador) {
        ...
        public void receberJogada(int informarDado1, int informarDado2, int informarSomaDados, 
                int informarTotalApostasJogador1, int informarTotalApostasJogador2, int informarPoint, 
                List informarApostasJogador1, List informarApostasJogador2, int contaJogada, int resultadoRodada){
